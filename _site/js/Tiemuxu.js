(function(){
    if (!window.Tiemuxu) {
        window['Tiemuxu'] = {}; // My own name space
        ...
        window['Tiemuxu']['id'] = id;
        window['Tiemuxu']['tag'] = tag;
        ...
        window['Tiemuxu']['hasClass'] = hasClass;
        ...
        window['Tiemuxu']['hasAttribute'] = hasAttribute;
        window['Tiemuxu']['attr'] = attr;
        ...
        // 注入HTML结束
        window['Tiemuxu']['checkElem'] = checkElem;
        window['Tiemuxu']['before'] = before;
        window['Tiemuxu']['append'] = append;
        ...
        window['Tiemuxu']['stopBubble'] = stopBubble;
        window['Tiemuxu']['stopDefault'] = stopDefault;
        ...
        window['Tiemuxu']['getStyle'] = getStyle;
        ...
        window['Tiemuxu']['setOpacity'] = setOpacity;
        window['Tiemuxu']['show'] = show;
        window['Tiemuxu']['hide'] = hide;
        window['Tiemuxu']['fadeIn'] = fadeIn;
        window['Tiemuxu']['fadeOut'] = fadeOut;
        ...
        window['Tiemuxu']['getHeight'] = getHeight;
        window['Tiemuxu']['getWidth'] = getWidth;
        window['Tiemuxu']['fullHeight'] = fullHeight;
        window['Tiemuxu']['fullWidth'] = fullWidth;
        window['Tiemuxu']['resetCSS'] = resetCSS;
        window['Tiemuxu']['restoreCSS'] = restoreCSS;
        ...
        window['Tiemuxu']['scrollY'] = scrollY;
        ...
        // 事件监听函数库结束 
        window['Tiemuxu']['addEvent'] = addEvent;
        window['Tiemuxu']['removeEvent'] = removeEvent;
        window['Tiemuxu']['handleEvent'] = handleEvent;
        window['Tiemuxu']['fixEvent'] = fixEvent;      
        ...
        // 监听DOM可用与否的函数结束
        window['Tiemuxu']['domReady'] = domReady;
        window['Tiemuxu']['isDOMReady'] = isDOMReady;
    }
})();
